...
public class AppRestController {
    ...
    public RedirectView processForm1() {
        ...
        String url = "https://chamal.auth0.com/authorize"+
                    "?audience=https://chamal.auth0.com/api/v2/"+
                    "&scope=openid%20profile"+
                    "&response_type=code"+
                    "&client_id=mexVcW03HrbRLR5tQuxa8WVRco0X6MAB"+
                    "&redirect_uri=http%3A%2F%2Flocalhost%3A9999%2Foauth%2Faccess"+
                    "&state=123";
    ...
    public String getAuthResponse(String authCode)
    {
        ...
        String POST_PARAMS = "grant_type=authorization_code"+
                            "&client_id=mexVcW03HrbRLR5tQuxa8WVRco0X6MAB"+
                            "&client_secret=LdcRgFq9-YFe3Z-AUEaXofUs-ciFoAlBdPqXtrxhHKZH7oURuzM1TxBx_lEgWmrJ"+
                            "&code="+authCode+
                            "&redirect_uri=http%3A%2F%2Flocalhost%3A9999%2Foauth%2Faccess";
        String authReponse = "";
